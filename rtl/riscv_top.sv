/*
 *  5-Stage Pipelined RISC-V (RV32I)
...
module riscv_top (
    ...
    logic        mem_to_reg_ex, alu_src_ex, branch_ex;

    logic [31:0] alu_in_a, alu_in_b;
    logic [31:0] forward_b_mux_out;
    ...
    assign pc_next = branch_taken ? branch_target_ex : pc_plus4_if;
    ...
    always_comb begin
        case (instr_id[6:0])
            7'b0010011,
            7'b0000011:
                imm_id = {{20{instr_id[31]}}, instr_id[31:20]}; // I-type

            7'b0100011:
                imm_id = {{20{instr_id[31]}}, instr_id[31:25], instr_id[11:7]}; // S-type

            7'b1100011:
                imm_id = {{19{instr_id[31]}},
                          instr_id[31],
                          instr_id[7],
                          instr_id[30:25],
                          instr_id[11:8],
    ...
    assign write_data_wb =
        mem_to_reg_wb ? mem_read_data_wb : alu_result_wb;
